...
# Priority order: first entry whose API key is set wins. Reorder to change precedence.
_PROVIDERS = [
...
def get_model() -> str:
    """Select the AI model based on available API keys and their model variables."""
